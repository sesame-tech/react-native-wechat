...
public class RNWechatModule extends ReactContextBaseJavaModule implements IWXAPIEventHandler {
    ...
    private static RNWechatModule module = null;
        ...
        if (uri != null) {
            this._getImage(uri, new ResizeOptions(100, 100), new ImageCallback() {
                ...
                public void invoke(@Nullable Bitmap bitmap) {
                    RNWechatModule.this._share(scene, data, bitmap, callback);
                }
            });
        } else {
            ...
            __jsonToImageUrlMedia(data, new MediaObjectCallback() {
                ...
                public void invoke(@Nullable WXMediaMessage.IMediaObject mediaObject) {
                    if (mediaObject == null) {
                        ...
                        RNWechatModule.this._share(scene, data, thumbImage, mediaObject, callback);
                    }
                }
            });
            return;
